...
<div class="wrapper content">
  ...
  <div class="box">
    <!--Begin Login Header-->
    <div class="header">
      <p><img src="images/half_width_icon.png" alt="Half Width Box" width="30" height="30" />Login Panel</p>
    </div>
    <!--End Login Header-->
    <div class="body">
      <form  action="index.html" method="get">
        <p>
          <label>User ID:</label>
          <input name="textfield" type="text" class="textfield large" id="textfield" />
        </p>
        <p>
          <label>Password:</label>
          <input name="textfield2" type="text" class="textfield large" id="textfield2" />
        </p>
        <p>
  ...
  <div class="info">
    <strong><img src="images/iinfo_icon.png" alt="Information" width="28" height="29" class="icon" /></strong>Just press login to continue.<a href="#" class="close_notification" title="Click to Close"><img src="images/close_icon.gif" width="6" height="6" alt="Close" /></a>
  </div>
</div>
<!--End Wrapper-->
